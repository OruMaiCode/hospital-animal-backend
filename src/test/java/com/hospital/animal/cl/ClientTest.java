...
import com.hospital.animal.cl.services.impl.ClientServiceImpl;
...
class ClientTest {
    ...
    @Order(1)
    @Test
    void createClient() throws InterruptedException, ExecutionException {
    ...
    void getAllClient() throws InterruptedException, ExecutionException {
        ...
        clients.stream().forEach((c)->{
            ...
            Assertions.assertEquals(LOCATION.address,c.getLocation().getAddress());
    ...
    void getClient() throws InterruptedException, ExecutionException {
        ...
        Assertions.assertEquals(LOCATION.address,client1.getLocation().getAddress());
        ...
        Assertions.assertEquals(LONGITUDE,client1.getLocation().getCoordinates().getLng());
          ...
          Assertions.assertThrows(RuntimeException.class,()->{
              Client client2 = clientService.get(null);
          });
